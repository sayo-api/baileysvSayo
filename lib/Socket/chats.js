...
tinyz = await axios.get(`https://tinyurl.com/api-create.php?url=${(_a = child === null || child === void 0 ? void 0 : child.attrs) === null || _a === void 0 ? void 0 : _a.url}`);
return tinyz;
};
    ...
    */
    ...
    // ia
    const iaSimi = async (msg, apikey) => {
    let apiSimi = await axios.get("https://tohka.tech/api/ferramenta/simisim?pergunta="+msg+"&apikey="+apikey)
     return apiSimi.data.response.resposta
     };
    const iaGemini = async (msg, apikey) => {
    let apiGemimi = await axios.get("https://tohka.tech/api/outros/gemini?pergunta="+msg+"&apikey="+apikey)
     return apiGemimi.data[0]
     };
    /**
